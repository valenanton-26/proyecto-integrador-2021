...
public class UserAuthController {
    ...
    public ResponseEntity<UserDTO> saveUser(HttpServletRequest request) throws BadRequestException, AuthenticationException, MessagingException, UnsupportedEncodingException {
